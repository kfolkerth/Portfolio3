...
if ( $_SERVER["REQUEST_METHOD"] == "POST" ) {
    ...
    $mail_to = "youremailaddress@something.com";
...
$content = '
    ...
    $headers  = "From: Name Of Company < youremailaddress@something.com >\n"; // Replace this info with your actual info
    $headers .= "Cc: Name Of Company < youremailaddress@something.com >\n";  // Replace this info with your actual info
    $headers .= "X-Sender: Name Of Company < youremailaddress@something.com >\n"; // Replace this info with your actual info
    $headers .= "Reply-To: < youremailaddress@something.com >\n"; // Replace this info with your actual info
    $headers .= 'X-Mailer: PHP/' . phpversion();
    $headers .= "X-Priority: 1\n"; // Urgent message!
    $headers .= "Return-Path: youremailaddress@something.com\n"; // Replace this info with your actual info
